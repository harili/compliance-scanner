        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgencyLogo = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxWebsites = table.Column<int>(type: "integer", nullable: false),
                    MaxScansPerMonth = table.Column<int>(type: "integer", nullable: false),
                    ApiAccess = table.Column<bool>(type: "boolean", nullable: false),
                    BrandedReports = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ScanId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ...
                    WarningIssues = table.Column<int>(type: "integer", nullable: false),
                    InfoIssues = table.Column<int>(type: "integer", nullable: false),
                    ErrorMessage = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ReportPdfPath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScanResults_Websites_WebsiteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RgaaRule = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    ElementSelector = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ElementHtml = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccessibilityIssues_ScanResults_ScanResultId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessibilityIssues_RgaaRule_ScanResultId",
                table: "AccessibilityIssues",
                columns: new[] { "RgaaRule", "ScanResultId" });

            migrationBuilder.CreateIndex(
                name: "IX_AccessibilityIssues_ScanResultId",
                table: "AccessibilityIssues",
                column: "ScanResultId");
